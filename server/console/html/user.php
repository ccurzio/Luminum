	...
	<div class="module-content" style="padding: 0; width: 75%; margin-left: auto; margin-right: auto; padding: 10px;">
		<div style="margin-top: 10px;">
			<table style="width: 75%; border: 0; margin-left: auto; margin-right: auto; margin-top: 15px; margin-bottom: 15px;">
                        ...
                        <tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Phone:</td><td style="color: #444; background-color: transparent; border: 0; font-weight: normal;"><input id="phone" type="text" value="<?php print $userinfo["PHONE"]; ?>" maxlength="21" tabindex="4"></td><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Two-Factor Authentication:</td><td style="color: #444; background-color: transparent; border: 0; font-weight: normal;">
			<select id="2FA" style="height: 28px; width: 200px; margin-left: 3px;" tabindex="8"><option value="enabled">Enabled</option><option value="disabled">Disabled</option></select>
			</td></tr>

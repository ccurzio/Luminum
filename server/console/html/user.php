...
<div class="content">
	<h1>Account Profile</h1>
		...
		<div style="width: 100%; text-align: right; margin: -50px auto 10px auto;">
			<button id="save" class="formgo" style="margin-right: 163px;" disabled="disabled">Save Changes</button>
		</div>
	...
	<div class="module-content" style="width: 75%; margin-left: auto; margin-right: auto;">
		<div style="margin-top: 10px;">
			...
			<select id="2FA" style="height: 28px; width: 200px; margin-left: 3px;"><option value="enabled">Enabled</option><option value="disabled">Disabled</option></select>
                        ...
                        <tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold; padding-top: 15px;">Role:</td><td style="color: #444; background-color: transparent; border: 0; font-weight: normal; padding-top: 15px;"> <?php print $userrole; ?></td></tr>

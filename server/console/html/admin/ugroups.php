...
$ugquery = mysqli_query($db, "select ID,NAME,AUTHOR,CREATED,MODIFIED,EDITOR from GROUPS order by NAME");
$endtime = microtime(true);

$duration = number_format((float)$endtime - $starttime, 2, '.', '');
$ugcount = mysqli_num_rows($ugquery);
?>

<div class="content">

<?php if ($_GET["view"] == "ugroups"): ?>
		...
		<a href="/index.php?view=ugroups&action=new"><button class="formgo" style="margin-top: 5px; margin-right: 0;">Create New</button></a>
		...
		<tr><td colspan="7"><div style="position: absolute; padding-top: 5px; padding-left: 5px;">0 of <?php print $ugcount; ?> items</div><div style="float: right; text-align: right; padding-right: 5px;">Filter: <input type="text" style="font-size: 15px; padding: 3px; margin-top: 0;" maxlength="64" <?php if ($ugcount == 0) { print "disabled=\"disabled\""; } ?>></div></td></tr>

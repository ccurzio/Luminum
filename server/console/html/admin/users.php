...
<div class="content">
	...
	<div class="module-content">
		...
		<tr><td style="width: 15px;"><input type="checkbox" id="checkall" onclick="selectAll()"></td><td style="width: 50px; text-align: center;">UID</td><td style="width: 75px; text-align: center;">Enabled</td><td style="width: 120px;">Username</td><td>Full Name</td><td style="width: 90px;">Role</td><td style="width: 90px;">Type</td><td>Created</td><td>Last Login</td></tr>

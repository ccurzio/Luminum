...
<div class="content">
	...
	<div class="module-content">
		...
		<tr><td colspan="10"><div style="position: absolute; padding-top: 5px; padding-left: 5px;">0 of 0 items <img id="refresh" src="icons/refresh.png" style="cursor: pointer; margin-left: 2px; width: 20px; height: 20px; vertical-align: text-bottom;" onclick="reloadTable()"></div><div style="float: right; text-align: right; padding-right: 5px;">Filter: <input type="text" style="font-size: 15px; padding: 3px; margin-top: 0;" <?php if ($actioncount == 0) { print "disabled=\"disabled\""; } ?> maxlength="64"></div></td></tr>
		<tr><td style="width: 15px;">
		<?php
		if ($actioncount == 0) { print "<input type=\"checkbox\" disabled=\"disabled\">"; }
		else { print "<input type=\"checkbox\">"; }
		?>
		</td><td style="width: 30px; text-align: center;">Enabled</td><td style="width: 30px;">Status</td><td style="width: 300px;">Name</td><td style="width: 100px;">Issuer</td><td style="width: 175px;">Start Date</td><td style="width: 175px;">End Date</td><td style="width: 75px;">Repeat</td><td style="width: 175px;">Last Modification</td><td style="width: 100px;">Modified By</tr>

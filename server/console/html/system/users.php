...
<div class="content">
	...
	<div class="module-content">
		...
		<tr><td colspan="9"><div style="position: absolute; padding-top: 5px; padding-left: 5px;"> <span id="usercount">0</span> <span id="totusercount">of <?php print $usercount; ?> items</span></div><div style="float: right; text-align: right; padding-right: 5px;">Filter: <input type="text" style="font-size: 15px; padding: 3px; margin-top: 0;" maxlength="64"></div></td></tr>

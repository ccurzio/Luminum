...
<div class="content">
	...
	<div class="module-content" style="padding: 0;">
		...
		<div id="Content" class="configtab" style="display: none;">
			<table style="width: 50%; border: 0; margin-left: auto; margin-right: auto; margin-top: 15px; margin-bottom: 15px;">
			<tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Default Content Set for Sensors: </td><td style="background-color: transparent; border: 0;"><select id="sensorset" style="width: 175px; height: 28px;">
			...
			<tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Default Content Set for Packages: </td><td style="background-color: transparent; border: 0;"><select id="sensorset" style="width: 175px; height: 28px;">
			<?php foreach ($csopts as $value) { print $value; } ?>
		...
		<div id="Logins" class="configtab" style="display: none;">
			<table style="width: 50%; border: 0; margin-left: auto; margin-right: auto; margin-top: 15px; margin-bottom: 15px;">
			<tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Minimum Password Length: </td><td style="color: #444; background-color: transparent; border: 0; font-weight: normal;"><input id="passlen" type="text" style="width: 25px; font-size: 15px; padding: 3px; margin-top: 0;" maxlength="2"> Characters</td></tr>
			<tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Password Complexity Enforcement: </td><td style="color: #444; background-color: transparent; border: 0; font-weight: normal;"><select id="minactconf" style="width: 175px; height: 28px;"><option value="enabled">Enabled</option><option value="disabled">Disabled</option></select> <div class="tooltip"><img src="/icons/help.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Require user passwords to include specified characters<br><br>Default: Disabled</span></div></td></tr>
			<tr><td style="color: #444; background-color: transparent; border: 0;"></td><td style="color: #444; background-color: transparent; border: 0; font-weight: normal;"><input id="pwdcase" type="checkbox"> Upper and Lowercase<br><input id="pwdnums" type="checkbox"> Letters and Numbers<br><input id="pwdspec" type="checkbox"> Special Characters</td></tr>

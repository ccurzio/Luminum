...
<div class="content">
	...
	<div class="module-content" style="padding: 0;">
		...
		<div id="General" class="configtab">
			...
			<div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Specifies the minimum number of targeted clients requiring confirmation for action deployments<br><br>Default: Enabled; 250 Endpoints</span></div></td></tr>
			...
			<div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Enable or disable Luminum Investigate<br><br>Default: Enabled</span></div></td></tr>
			</table>
		</div>
		...
		<div id="Content" class="configtab" style="display: none;">
			...
			</select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">The content set to which newly-created sensors will be added by default<br><br>NOTE: Orphaned sensors will also be moved to this content set</span></div></td></tr>
			...
			<?php foreach ($csopts as $value) { print $value; } ?>
			</select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">The content set to which newly-created packages will be added by default<br><br>NOTE: Orphaned packages will also be moved to this content set</span></div></td></tr>
			<tr><td style="color: #444; background-color: transparent; border: 0; font-weight: bold;">Sensor Edit History:</td><td style="background-color: transparent; border: 0;"><select id="sensorhist" style="width: 175px; height: 28px;" onchange="srevCheck();"><option value="Enabled" <?php if ($senrevs > 0) { print "selected=\"selected\""; } ?>>Enabled</option><option value="Disabled" <?php if ($senrevs == 0) { print "selected=\"selected\""; } ?>>Disabled</option></select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Enables or disables the ability to retain previous versions of sensors.<br><br>Default: Enabled, 5 Revisions</span></div></td></tr>
			<?php
			if ($senrevs > 0) { print "<tr><td style=\"color: #444; background-color: transparent; border: 0; font-weight: normal; padding-left: 30px;\"><span id=\"shrlabel\" style=\"color: #444;\">Sensor History Retention:</span></td><td style=\"color: #444; background-color: transparent; border: 0; font-weight: normal;\"><input id=\"srevcnt\" type=\"text\" style=\"width: 60px; font-size: 15px; padding: 3px; margin-top: 0;\" maxlength=\"2\" value=\"" . $senrevs . "\" onchange=\"formCheck();\"> <span id=\"srlabel\" style=\"color: #444;\">Revisions</span></td></tr>\n"; }
		...
		<div id="Accounts" class="configtab" style="display: none;">
			...
			?>
			</select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Sets the 2FA policy for all user accounts<br><br>Default: Optional</span></td></tr>
			...
			?>
			</select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Require user passwords to include specified characters<br><br>Default: Disabled</span></div></td></tr>
			...
			?>
			</select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">The length of time before a user is automatically logged out due to inactivity<br><br>Default: 15 Minutes</span></div></td></tr>
			...
			?>
			</select> <div class="tooltip"><img src="/icons/tooltip.png" style="width: 15px; height: 15px; opacity: 0.33; vertical-align: top;"> <span class="tooltiptext">Displays a warning to the user 2 minutes before they are automatically logged out<br><br>Default: Enabled</span></div></td></tr></td></tr>
			</table>
		</div>
	</div>
	</form>
...
<script>
const mtElement = document.getElementById('actconfclients');
const ciElement = document.getElementById('checkinint');
const maElement = document.getElementById('missingafter');
const srElement = document.getElementById('srevcnt');
...
ciElement.addEventListener('input', function(event) {
	document.getElementById('checkinint').value = numbersOnly(document.getElementById('checkinint').value);
	formCheck();
	});

maElement.addEventListener('input', function(event) {
	document.getElementById('missingafter').value = numbersOnly(document.getElementById('missingafter').value);
	formCheck();
	});

srElement.addEventListener('input', function(event) {
	document.getElementById('srevcnt').value = numbersOnly(document.getElementById('srevcnt').value);
	formCheck();
	});

prElement.addEventListener('input', function(event) {
	document.getElementById('prevcnt').value = numbersOnly(document.getElementById('prevcnt').value);
	formCheck();
	});

mpElement.addEventListener('input', function(event) {
	document.getElementById('passlen').value = numbersOnly(document.getElementById('passlen').value);
	formCheck();
	});

iaElement.addEventListener('input', function(event) {
	document.getElementById('inactiveint').value = numbersOnly(document.getElementById('inactiveint').value);
	formCheck();
	});
